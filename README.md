...
Version 2.1.10 changes the default web app endpoint to `https://booking.vre-vietnam.com` and automatically migrates existing settings that still point to the retired `vrena-booking.vercel.app` hostname. Custom HTTPS endpoints are preserved.
